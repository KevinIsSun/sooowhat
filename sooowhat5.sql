...
--
-- Host: 127.0.0.1
-- Generation Time: 2015-04-19 04:54:33
-- 服务器版本： 5.6.20
-- PHP Version: 5.5.20
...
('265826712b5b092b8098a07e849cd295', '::1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.90 Safari/537.36', 1429372440, 'a:3:{s:9:"user_data";s:0:"";s:4:"name";s:5:"admin";s:9:"logged_in";b:1;}'),
...
INSERT INTO `project` (`id`, `content`, `position`, `name`) VALUES
(1, 'project5', 1, 'name1'),
(2, 'project5', 2, 'name'),
(3, 'project5', 3, 'name'),
(4, 'project5', 4, 'name'),
...
INSERT INTO `team` (`id`, `content`, `position`) VALUES
(1, 'team descssss', 1),
(2, 'team desc', 2);
